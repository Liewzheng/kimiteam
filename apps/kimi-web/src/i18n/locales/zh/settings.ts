export default {
  ...
  notifyTitle: 'Kimi Team · 回合完成',
  notifyQuestionTitle: 'Kimi Team · 待回答',
  notifyApprovalTitle: 'Kimi Team · 等待审批',
  ...
  providersDesc: '添加你自己的 API 密钥即可使用第三方模型——配置会自动写入 config.toml，无需手动编辑文件。',
  providersNone: '尚未配置任何提供商。',
  manageProviders: '管理',
  saving: '保存中',
  defaultModel: '默认模型',
