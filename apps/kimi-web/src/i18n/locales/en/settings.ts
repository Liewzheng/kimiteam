export default {
  ...
  notifyTitle: 'Kimi Team · Turn finished',
  notifyQuestionTitle: 'Kimi Team · Needs answer',
  notifyApprovalTitle: 'Kimi Team · Approval required',
  ...
  providersDesc: 'Add your own API key to use third-party models — settings are written to config.toml automatically, no file editing.',
  providersNone: 'No providers configured yet.',
