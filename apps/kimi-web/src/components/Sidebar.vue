      ...
      <div class="ch">
        <div class="ch-brand">
          <template v-if="!isMacosDesktop">
            <svg ref="logoRef" class="ch-logo" :class="{ 'is-dev': isDev }" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Kimi Team" @click="onLogoClick" @pointerdown="onLogoPointerDown" @pointerup="onLogoPointerUp" @pointercancel="onLogoPointerUp">
              <defs>
            ...
            <span class="ch-name">Kimi Team</span>
            <Pill
              v-if="isDev"
              class="ch-backend"
