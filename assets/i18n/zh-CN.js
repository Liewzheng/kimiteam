...
LANDING_I18N['zh-CN'] = {
  ...
  'meta.features.desc': 'kimiteam 核心特性：多智能体独立角色与模型分工、后台并行派工、TeamScore 绩效与通胀检测、score_gate 验收门禁、具名名册与三态生命周期、技能与 memory 复用、TUI + Web 双形态。',
  ...
  'index.stats.label3': '成员三态生命周期',
  'index.stats.label4': '主管只做 4 件事：拆任务 · 配人 · 控冲突 · 审结果',
  ...
  'features.f5.k': 'ROSTER · 具名名册与三态生命周期',
  'features.f5.h3': '谁在干活，谁在休息，一目了然。',
  'features.f5.body': '具名工程师名册 + 三态生命周期：working / resting / off-duty。/team 面板实时呈现每位成员的岗位、模型、均分与当前状态。on-duty（本会话未出勤）与 off-duty（已归档）在界面上统一显示为「下班」。',
