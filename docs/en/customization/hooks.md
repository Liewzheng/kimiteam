---
url: /kimiteam/docs/en/customization/hooks.md
---
# Hooks
...
Specific events will also include additional fields (such as tool name and command content); see the event reference below. All field names use snake\_case.
